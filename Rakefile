...
desc 'Generate documentation for the products_page_remover extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ProductsPageRemoverExtension'
...
desc 'Test the products_page_remover extension.'
